...
public class RCCP_Lod : RCCP_Component {
    ...
    public override void Awake() {
        ...
        // Direct reference — AllWheelColliders is itself a cached array, no defensive copy needed.
    ...
    // OnEnable intentionally NOT overridden — RCCP_Component.OnEnable already runs
    // CheckOnEnableDisable → Lod.Reload → LODLevelChanged on enable, so an override
    // here would just call LODLevelChanged a second time (dead work).
