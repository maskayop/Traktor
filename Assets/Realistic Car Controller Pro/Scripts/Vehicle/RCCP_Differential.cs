...
public class RCCP_Differential : RCCP_Component {
    ...
    /// </summary>
    /// <param name="targetOutputLeft">Override torque for the left wheel.</param>
    /// <param name="targetOutputRight">Override torque for the right wheel.</param>
    ...
    /// <summary>Disables the differential override, returning to automatic torque distribution.</summary>
    ...
    /// </summary>
    /// <param name="output">The drivetrain output containing torque and RPM values.</param>
