...
public class RCCP_WheelSlipParticles : RCCP_Component {
    ...
    public ParticleSystem WheelParticles {
        ...
        get {
            ...
            if (!wheelParticles) {
                ...
                if (!loggedMissingParticles) {
                    loggedMissingParticles = true;
                    Debug.LogError("Particles couldn't be found on this GameObject named " + gameObject.name + "! Ensure your prefab has a proper ParticleSystem if you intend to use wheel slip effects.", this);
                }
                return null;
    ...
    private bool loggedMissingParticles;
