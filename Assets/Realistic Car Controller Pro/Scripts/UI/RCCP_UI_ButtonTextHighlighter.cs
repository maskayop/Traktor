...
public class RCCP_UI_ButtonTextHighlighter : RCCP_UIComponent, IPointerEnterHandler, IPointerExitHandler {
    ...
    /// </summary>
    [Tooltip("Text color when the pointer is not hovering over the button.")]
    public Color defaultTextColor = Color.white;

    /// <summary>
    /// Color for the target (highlighted) text state.
    /// </summary>
    [Tooltip("Text color that the label transitions to while the pointer hovers over the button.")]
    ...
    /// </summary>
    [Tooltip("How fast the text color lerps between default and highlighted states.")]
