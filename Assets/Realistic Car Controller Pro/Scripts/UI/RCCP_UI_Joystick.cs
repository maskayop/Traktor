...
public class RCCP_UI_Joystick : RCCP_UIComponent, IDragHandler, IPointerUpHandler, IPointerDownHandler {
    ...
    /// </summary>
    [Tooltip("RectTransform of the joystick background circle used to calculate input bounds.")]
    public RectTransform backgroundSprite;

    /// <summary>
    /// Handle sprite of the joystick.
    /// </summary>
    [Tooltip("RectTransform of the draggable joystick handle that follows touch input.")]
    ...
    /// <summary>Updates the joystick position and input values based on drag movement.</summary>
