...
public class RCCP_UI_Decal : RCCP_UIComponent {
    ...
    /// </summary>
    [Tooltip("Decal placement index: 0=front, 1=back, 2=left, 3=right.")]
    [Min(0)] public int location = 0;

    /// <summary>
    /// Target material.
    /// </summary>
    [Tooltip("Material containing the decal texture to apply to the vehicle.")]
    public Material material;

    /// <summary>Applies the selected decal material to the vehicle at the configured location.</summary>
    public void Upgrade() {
