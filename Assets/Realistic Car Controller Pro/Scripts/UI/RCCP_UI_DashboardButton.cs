...
public class RCCP_UI_DashboardButton : RCCP_UIComponent, IPointerClickHandler {
    ...
    public enum ButtonType {
        ...
        /// <summary>Start the vehicle engine.</summary>
        StartEngine,

        /// <summary>Stop the vehicle engine.</summary>
        StopEngine,

        /// <summary>Toggle Anti-lock Braking System.</summary>
        ABS,

        /// <summary>Toggle Electronic Stability Program.</summary>
        ESP,

        /// <summary>Toggle Traction Control System.</summary>
        TCS,

        /// <summary>Toggle low-beam headlights.</summary>
        Headlights,

        /// <summary>Toggle left turn indicator.</summary>
        LeftIndicator,
        ...
        /// <summary>Shift gear down (manual transmission).</summary>
        GearDown,

        /// <summary>Toggle hazard warning lights (all indicators).</summary>
        HazardLights,

        /// <summary>Cycle to the next camera view.</summary>
        ChangeCamera,

        /// <summary>Toggle steering helper for velocity-aligned steering correction.</summary>
        SteeringHelper,

        /// <summary>Toggle traction helper to limit wheel spin.</summary>
        TractionHelper,
        ...
        /// <summary>Toggle between manual and automatic transmission.</summary>
        GearToggle,

        /// <summary>Select automatic gear Drive (D).</summary>
        AutomaticGear_D,

        /// <summary>Select automatic gear Neutral (N).</summary>
        AutomaticGear_N,

        /// <summary>Select automatic gear Reverse (R).</summary>
        AutomaticGear_R,

        /// <summary>Select automatic gear Park (P).</summary>
        AutomaticGear_P,

        /// <summary>Switch transmission to Automatic mode.</summary>
        GearToggleAutomatic,

        /// <summary>Switch transmission to Automatic DNRP mode.</summary>
        GearToggleDNRP,

        /// <summary>Switch transmission to Manual mode.</summary>
        GearToggleManual,

        /// <summary>Open the options/settings panel.</summary>
        Options

    };
    [Tooltip("Vehicle action triggered when this button is clicked.")]
    public ButtonType buttonType = ButtonType.ChangeCamera;

    /// <summary>
    /// On image will be used?
    /// </summary>
    [Tooltip("Visual indicator shown when the toggled feature is active.")]
    ...
    /// <summary>
    /// Handles pointer click events by dispatching the corresponding vehicle input action based on the configured button type.
    /// </summary>
