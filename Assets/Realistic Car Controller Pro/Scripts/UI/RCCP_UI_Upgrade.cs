...
public class RCCP_UI_Upgrade : RCCP_UIComponent {
    ...
    /// </summary>
    [Tooltip("Which vehicle performance stat this button upgrades.")]
    ...
    /// </summary>
    [Tooltip("Text element displaying the current upgrade level for this stat.")]
    ...
    /// <summary>Upgrades the corresponding vehicle performance stat (engine, handling, brake, or speed) by one level.</summary>
    public void OnClick() {
