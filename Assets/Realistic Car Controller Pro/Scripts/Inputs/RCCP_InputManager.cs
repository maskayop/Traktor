...
public class RCCP_InputManager : RCCP_Singleton<RCCP_InputManager> {
    ...
    /// </summary>
    [Tooltip("Live input values collected from keyboard, gamepad, or mobile each frame.")]
    public RCCP_Inputs inputs = new RCCP_Inputs();

    /// <summary>
    /// Reference to the Input Actions asset instance
    /// </summary>
    [Tooltip("Runtime instance of the Input Actions asset used for binding resolution.")]
    ...
    /// </summary>
    [Tooltip("When enabled, device inputs are ignored and values from OverrideInputs() are used instead.")]
