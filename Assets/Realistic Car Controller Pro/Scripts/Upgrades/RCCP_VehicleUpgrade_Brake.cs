...
public class RCCP_VehicleUpgrade_Brake : RCCP_Component {
    ...
    /// </summary>
    [Tooltip("Brake torque multiplier applied per upgrade level. 1 = stock, 2 = double stock brake torque at max level.")]
    ...
    /// <summary>Resets the brake upgrade level back to stock (level 0).</summary>
    public void Restore() {
