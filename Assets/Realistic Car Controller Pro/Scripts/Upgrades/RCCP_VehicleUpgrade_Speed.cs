...
public class RCCP_VehicleUpgrade_Speed : RCCP_Component {
    ...
    /// </summary>
    [Tooltip("Max-speed multiplier applied per upgrade level. 1 = stock, 2 = double stock top speed at max level.")]
    ...
    /// <summary>Resets the speed upgrade level back to stock (level 0).</summary>
    public void Restore() {
