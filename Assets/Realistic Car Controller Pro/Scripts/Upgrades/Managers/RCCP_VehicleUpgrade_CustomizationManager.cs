...
public class RCCP_VehicleUpgrade_CustomizationManager : RCCP_UpgradeComponent, IRCCP_UpgradeComponent {
    ...
    /// </summary>
    [Tooltip("Current customization data applied to the vehicle (suspension, steering, driving aids).")]
    public RCCP_CustomizationData customizationData = new RCCP_CustomizationData();

    /// <summary>
    /// Default customization data.
    /// </summary>
    [Tooltip("Default customization data captured on Awake, used to restore stock values.")]
    public RCCP_CustomizationData customizationDataDefault = new RCCP_CustomizationData();

    /// <summary>
    /// Starts the delayed initialization coroutine that reads saved customization data from the loadout and applies it to the vehicle.
    /// </summary>
    ...
    /// Set Smoke Color.
    /// </summary>
    /// <param name="color">The new tire smoke particle color.</param>
    ...
    /// </summary>
    /// <param name="color">The new headlight color tint.</param>
    ...
    /// </summary>
    /// <param name="camberAngle">The camber angle in degrees to apply to front wheels.</param>
    ...
    /// </summary>
    /// <param name="camberAngle">The camber angle in degrees to apply to rear wheels.</param>
    ...
    /// </summary>
    /// <param name="targetPosition">Suspension target position (0 = fully extended, 1 = fully compressed).</param>
    ...
    /// </summary>
    /// <param name="distance">The suspension travel distance in meters.</param>
    ...
    /// </summary>
    /// <param name="targetValue">The spring force value in Newtons.</param>
    ...
    /// </summary>
    /// <param name="targetValue">The damper force value.</param>
