...
public class RCCP_VehicleUpgrade_UpgradeManager : RCCP_UpgradeComponent, IRCCP_UpgradeComponent {
    ...
    /// <summary>Initializes upgrade levels from the saved loadout and applies them to the vehicle.</summary>
    ...
    /// Upgrades the engine torque.
    /// </summary>
    /// <param name="level">The engine upgrade level to apply.</param>
    ...
    /// Upgrades the brake torque.
    /// </summary>
    /// <param name="level">The brake upgrade level to apply.</param>
    ...
    /// Upgrades the traction helper (Handling).
    /// </summary>
    /// <param name="level">The handling upgrade level to apply.</param>
    ...
    /// Upgrades the speed.
    /// </summary>
    /// <param name="level">The speed upgrade level to apply.</param>
