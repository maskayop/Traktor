...
public class RCCP_CameraCarSelection : RCCP_GenericComponent {
    ...
    /// Camera target.
    /// </summary>
    [Tooltip("The vehicle or object the showroom camera orbits around.")]
    public Transform target;

    /// <summary>
    /// Distance to the target.
    /// </summary>
    [Min(0f), Tooltip("Orbit radius from the target in world units.")]
    public float distance = 5f;

    /// <summary>
    /// X speed of the camera.
    /// </summary>
    [Min(0f), Tooltip("Horizontal orbit speed in degrees per second.")]
    public float speed = 25f;

    /// <summary>
    /// Angle of the camera.
    /// </summary>
    [Min(0f), Tooltip("Fixed vertical pitch angle of the camera in degrees (elevation above the target).")]
