...
public class RCCP_Skidmarks : RCCP_GenericComponent {
    ...
    /// </summary>
    [Tooltip("Maximum number of skidmark sections this instance can hold before recycling.")]
    [Min(128)] public int maxMarks = 1024;

    /// <summary>
    /// The distance the skidmarks is places above the surface it is placed upon. In meters.
    /// </summary>
    [Tooltip("Height offset in meters above the ground surface to prevent z-fighting.")]
    [Min(0f)] public float groundOffset = 0.02f;

    /// <summary>
    /// The minimum distance between two marks places next to each other.
    /// </summary>
    [Tooltip("Minimum distance in meters between consecutive skidmark sections.")]
    ...
    public class MarkSection {
        ...
        /// <summary>
        /// World position of the skidmark section center.
        /// </summary>
        [Tooltip("World position of the skidmark section center.")]
        public Vector3 pos = Vector3.zero;

        /// <summary>
        /// Surface normal at the skidmark position.
        /// </summary>
        [Tooltip("Surface normal at the skidmark position.")]
        public Vector3 normal = Vector3.zero;

        /// <summary>
        /// Tangent vector used for mesh UV generation.
        /// </summary>
        [Tooltip("Tangent vector used for mesh UV generation.")]
        public Vector4 tangent = Vector4.zero;

        /// <summary>
        /// Left edge world position of the skidmark quad.
        /// </summary>
        [Tooltip("Left edge world position of the skidmark quad.")]
        public Vector3 posl = Vector3.zero;

        /// <summary>
        /// Right edge world position of the skidmark quad.
        /// </summary>
        [Tooltip("Right edge world position of the skidmark quad.")]
        public Vector3 posr = Vector3.zero;

        /// <summary>
        /// Opacity of the skidmark (0 = invisible, 1 = fully opaque), stored as vertex color alpha.
        /// </summary>
        [Tooltip("Opacity of the skidmark from 0 (invisible) to 1 (fully opaque).")]
        public float intensity = 0.0f;

        /// <summary>
        /// Index of the previous connected skidmark section (-1 if this is the first section in a strip).
        /// </summary>
        [Tooltip("Index of the previous connected section (-1 if first in strip).")]
        public int lastIndex = 0;

    }

    /// <summary>
    /// Ring buffer of all skidmark sections managed by this instance.
    /// </summary>
    [Tooltip("Ring buffer of all skidmark sections managed by this instance.")]
    ...
    /// <summary>
    /// Adds a new skidmark section at the given position. Called by wheels that are slipping. Intensity controls the vertex alpha for fade-in/out.
    /// </summary>
    /// <param name="pos">World position to place the skidmark.</param>
    /// <param name="normal">Surface normal at the position.</param>
    /// <param name="intensity">Skidmark opacity (0-1). Values below 0 are rejected.</param>
    /// <param name="width">Width of the skidmark quad in meters.</param>
    /// <param name="lastIndex">Index of the previous section in this strip (-1 to start a new strip).</param>
    /// <returns>The index of the newly created section, or the unchanged lastIndex if too close to the previous mark.</returns>
    ...
    /// <summary>
    /// Rebuilds the skidmark mesh asynchronously using multithreading. Generates vertices, normals, tangents, UVs, colors, and triangles on a background thread.
    /// </summary>
    ...
    /// <summary>
    /// Rebuilds the skidmark mesh synchronously on the main thread. Used as fallback when multithreading is not supported.
    /// </summary>
    public void DrawRaw() {
    ...
    /// <summary>
    /// Cancels any pending async draw operations when the skidmarks object is destroyed.
    /// </summary>
