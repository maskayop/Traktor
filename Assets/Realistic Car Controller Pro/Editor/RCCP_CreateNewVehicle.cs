...
public class RCCP_CreateNewVehicle {
    ...
    public static RCCP_CarController NewVehicle(GameObject vehicle, RCCP_SetupWizardController.SetupData setupData) {
        ...
        // Per-vehicle WheelCollider substep override (independent of the behavior preset system).
        newVehicle.overrideWheelSubstepProfile = setupData.overrideWheelSubstepProfile;
        newVehicle.wheelSubstepProfile = setupData.wheelSubstepProfile;
