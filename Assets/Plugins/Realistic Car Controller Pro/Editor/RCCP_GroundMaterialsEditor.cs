...
public class RCCP_GroundMaterialsEditor : Editor {
    ...
    public override void OnInspectorGUI() {
        ...
        //  V2.51 (T2-7): the simulation reads a runtime clone in Play mode, so edits here won't apply live.
        if (Application.isPlaying)
            EditorGUILayout.HelpBox("Play mode uses a runtime CLONE of RCCP_GroundMaterials - edits in this inspector do NOT affect the running simulation.", MessageType.Info);
