...
public class RCCP_Visual_Dashboard : RCCP_Component {
    ...
    /// </summary>
    [Tooltip("Interior steering wheel transform that rotates with the vehicle's steering input.")]
    ...
    /// </summary>
    [Tooltip("Multiplier applied to the wheel steer angle for visual steering wheel rotation.")]
    [Min(0f)] public float steeringAngleMultiplier = 3f;

    /// <summary>
    /// Smoothing factor for steering wheel rotation, to prevent abrupt changes.
    /// </summary>
    [Tooltip("Interpolation speed for smooth steering wheel animation.")]
    ...
    public class RPMDial {
        ...
        /// </summary>
        [Tooltip("GameObject with the needle that rotates to display the value.")]
        public GameObject dial;

        /// <summary>
        /// Factor to multiply the source value (RPM or speed) before applying rotation.
        /// </summary>
        [Tooltip("Rotation multiplier converting the source value to needle angle.")]
        [Min(0f)] public float multiplier = .05f;

        /// <summary>
        /// Which axis the dial needle rotates around (X, Y, or Z).
        /// </summary>
        [Tooltip("Local axis the dial needle rotates around.")]
        ...
        /// </summary>
        [Tooltip("Optional TextMeshPro component displaying the numeric value.")]
    ...
    public class InteriorLight {
        ...
        [Tooltip("Light component used for this interior/dashboard light.")]
        public Light lightSource;
        [Tooltip("Maximum brightness when the interior light is active.")]
        [Range(0f, 10f)] public float intensity = 1f;
        [Tooltip("Render mode for this light (Auto, ForcePixel, or ForceVertex).")]
    ...
    /// </summary>
    [Tooltip("Dial configuration for displaying engine RPM on the dashboard.")]
    [Space()] public RPMDial rPMDial = new RPMDial();

    /// <summary>
    /// Dial for displaying speed, e.g., a needle that rotates proportionally to km/h.
    /// </summary>
    [Tooltip("Dial configuration for displaying vehicle speed on the dashboard.")]
    ...
    /// </summary>
    [Tooltip("Dashboard and cockpit lights that activate with the headlights.")]
    ...
    /// <summary>Resets all dashboard needle and gauge positions to their default states.</summary>
    public void Reload() {
