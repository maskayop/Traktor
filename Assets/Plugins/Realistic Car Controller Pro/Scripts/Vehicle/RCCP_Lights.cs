...
public class RCCP_Lights : RCCP_Component {
    ...
    [HideInInspector] public bool brakeLights = false;
    ...
    public void GetAllLights() {
        ...
        // Non-alloc overload fills the existing list instead of allocating a new array + List
        // via GetComponentsInChildren().ToList().
