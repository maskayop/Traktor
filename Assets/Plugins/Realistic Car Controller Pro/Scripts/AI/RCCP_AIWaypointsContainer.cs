...
public class RCCP_AIWaypointsContainer : RCCP_GenericComponent {
    ...
    /// </summary>
    [Tooltip("All waypoints belonging to this container (auto-populated from children).")]
    ...
    /// </summary>
    [Tooltip("Number of Catmull-Rom subdivisions per segment when smoothing the path.")]
    [Min(1)]
    ...
    /// </summary>
    [Tooltip("Height offset above ground when placing waypoints via raycast.")]
    [Min(0f)]
    ...
    /// </summary>
    [Tooltip("Layers to include when raycasting for ground placement.")]
