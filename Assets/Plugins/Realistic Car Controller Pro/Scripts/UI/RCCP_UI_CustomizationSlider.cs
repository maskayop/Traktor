...
public class RCCP_UI_CustomizationSlider : RCCP_UIComponent {
    ...
    /// </summary>
    [Tooltip("Which vehicle customization parameter this slider controls.")]
    ...
    /// </summary>
    [Tooltip("Text element showing the current numeric value of the slider.")]
    ...
    /// <summary>Applies the slider value to the corresponding vehicle customization parameter (camber, suspension, etc.).</summary>
