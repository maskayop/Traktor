...
public class RCCP_UI_Color : RCCP_UIComponent {
    ...
    /// Picked color.
    /// </summary>
    [Tooltip("Preset color applied to the vehicle when this button is clicked.")]
    ...
    /// <summary>Applies the configured color to the vehicle's smoke or headlights based on the selected color type.</summary>
    public void OnClick() {
