...
public class RCCP_CinematicCamera : RCCP_Singleton<RCCP_CinematicCamera> {
    ...
    /// // Animation Pivot.
    /// </summary>
    [Tooltip("Child object used as the animation pivot for cinematic camera movements.")]
    ...
    /// </summary>
    [Min(0f), Tooltip("Field of view used when the cinematic camera mode is active.")]
