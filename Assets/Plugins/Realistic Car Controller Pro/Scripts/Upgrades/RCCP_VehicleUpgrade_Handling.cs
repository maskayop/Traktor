...
public class RCCP_VehicleUpgrade_Handling : RCCP_Component {
    ...
    /// <summary>Current handling upgrade level.</summary>
    ...
    /// </summary>
    [Tooltip("Handling strength multiplier applied per upgrade level. 1 = stock, 2 = double stock handling at max level.")]
    ...
    /// <summary>Resets the handling upgrade level back to stock (level 0).</summary>
    public void Restore() {
