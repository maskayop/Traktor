...
public class RCCP_PoliceLights : RCCP_Component {
    ...
    /// </summary>
    [Tooltip("Current siren operating state (On or Off).")]
    ...
    /// Red lights.
    /// </summary>
    [Tooltip("Light components used for the red flashing siren effect.")]
    public Light[] redLights;

    /// <summary>
    /// Blue lights.
    /// </summary>
    [Tooltip("Light components used for the blue flashing siren effect.")]
    ...
    /// </summary>
    /// <param name="state">True to activate the siren, false to deactivate.</param>
