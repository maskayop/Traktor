...
public class RCCP_VehicleUpgrade_Engine : RCCP_Component {
    ...
    /// </summary>
    [Tooltip("Engine torque multiplier applied per upgrade level. 1 = stock, 2 = double stock torque at max level.")]
    ...
    /// <summary>Resets the engine upgrade level back to stock (level 0).</summary>
    public void Restore() {
