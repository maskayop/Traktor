...
public class RCCP_VehicleUpgrade_PaintManager : RCCP_UpgradeComponent, IRCCP_UpgradeComponent {
    ...
    /// All painters.
    /// </summary>
    [Tooltip("All paint upgrade components on this vehicle.")]
    public RCCP_VehicleUpgrade_Paint[] paints;

    /// <summary>
    /// Current color.
    /// </summary>
    [Tooltip("Currently applied body paint color.")]
    public Color color = Color.white;

    /// <summary>
    /// Default colors.
    /// </summary>
    [Tooltip("Original material colors stored for restoring to factory paint.")]
    ...
    /// <summary>Finds and caches all child RCCP_VehicleUpgrade_Paint components, including inactive ones.</summary>
    ...
    /// </summary>
    /// <param name="color">The paint color to apply and save to the loadout.</param>
    ...
    /// Runs all painters with the target color.
    /// </summary>
    /// <param name="color">The paint color to apply without saving to the loadout.</param>
