...
/// <summary>
/// Base class for all vehicle subsystem components. Provides cached access to RCCP singletons, auto-discovery of the parent RCCP_CarController, and type-based component registration.
/// </summary>
[DisallowMultipleComponent]
public abstract class RCCP_Component : MonoBehaviour, IRCCP_Component {
    ...
    /// <summary>
    /// Cached reference to the runtime changeable wheels singleton.
    /// </summary>
...
#if UNITY_EDITOR
    /// <summary>
    /// Editor flag indicating whether initial component setup is complete.
    /// </summary>
    [HideInInspector] public bool completeSetup = false;
    /// <summary>
    /// Editor flag indicating whether the setup check has been performed.
    /// </summary>
    ...
    /// <summary>
    /// Verifies the parent RCCP_CarController exists. Disables the component with an error if not found (except for Light, TrailerAttacher, and WheelSlipParticles).
    /// </summary>
    ...
    /// <summary>
    /// Called by Unity when enabled. Triggers component state checks and resets via CheckOnEnableDisable.
    /// </summary>
    ...
    /// Initializes and registers the target component.
    /// </summary>
    /// <param name="carController">The parent car controller to register the component with.</param>
    /// <param name="component">The component instance to register by type.</param>
