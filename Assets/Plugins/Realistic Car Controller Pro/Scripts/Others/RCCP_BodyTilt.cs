...
public class RCCP_BodyTilt : RCCP_Component {
    ...
    /// <summary>Resets the body tilt rotation back to its default orientation.</summary>
    public void Reload() {
